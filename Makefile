...
PhysiCell_custom_module_OBJECTS := custom.o DC_LNP_mRNA.o external_immune.o submodel_data_structures.o internal_mRNA_dynamics.o \
receptor_dynamics.o immune_submodels.o tumor_submodel.o
...
internal_mRNA_dynamics.o: ./custom_modules/internal_mRNA_dynamics.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/internal_mRNA_dynamics.cpp
...
tumor_submodel.o: ./custom_modules/tumor_submodel.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/tumor_submodel.cpp 
	
DC_LNP_mRNA.o: ./custom_modules/DC_LNP_mRNA.cpp
	$(COMPILE_COMMAND) -c ./custom_modules/DC_LNP_mRNA.cpp 
